...
<?php
$id = $_GET['qa_id'];
$query_3A = "SELECT * FROM bg_order WHERE id = '".$id."'";
$result_3A = mysqli_query($dbc,$query_3A)
	or die ('資料庫連結失敗');
$row = mysqli_fetch_array($result_3A);
...
<p><a href="bg_order_DATA.php">✚ 新增 Q&A 項目</a> ︱ <a href="bg_order_DELETE.php?dl_id=<?php echo $row['id'] ?>">✖ 刪除本篇內容</a></p>
<form action="bg_order_UPDATE.php?qa_id=<?=$row["id"]?>" method="post">
