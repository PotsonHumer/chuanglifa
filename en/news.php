        ...
        <div id="main_2">
            ...
            <div class="right">
				...
				while($row_2 = mysqli_fetch_array($result_2)){
					?>
   		    	<div class="news">
                	<div class="image"><a href="news_data.php?a_id=<?php echo $row_2['id']?>"><img src="<?php echo $row_2['image']?>" width="150" height="110" /></a></div>
                    <div class="data">
                    	<div class="t01"><?php echo $row_2['date']?> - <?php echo $row_2['title']?></div>
                    	<div class="t02"><a href="news_data.php?a_id=<?php echo $row_2['id']?>"><?php echo $row_2['textarea']?></a></div>
                    </div>
                </div>
                <?
				}
