...
$query = "INSERT INTO bg_news (web_title,fb_imge,fb_ds,project,en_name,image,title,textarea,date,editor) VALUES ('$web_title','$fb_imge','$fb_ds','$project','$en_name','$image','$title','$textarea','$date','$editor')";	
