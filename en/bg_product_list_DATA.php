...
<form action="bg_product_list_INSERT.php" method="post">
    ...
    <p>類別圖片:<input type="text" name="list_imge"><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a><font color="Green" face="微軟正黑體" size="0">建議尺寸:w150 x h150 / 72dpi</font></p>
    <p>產品圖片-01:<input type="text" name="list_imge_1"><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a><font color="Green" face="微軟正黑體" size="0">建議尺寸:w280 x h230 / 72dpi</font></p>
    <p>產品圖片-02:<input type="text" name="list_imge_2"><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a><font color="Green" face="微軟正黑體" size="0">建議尺寸:w280 x h230 / 72dpi</font></p>
    <p>產品圖片-03:<input type="text" name="list_imge_3"><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a><font color="Green" face="微軟正黑體" size="0">建議尺寸:w280 x h230 / 72dpi</font></p>
    <p>產品圖片-04:<input type="text" name="list_imge_4"><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a><font color="Green" face="微軟正黑體" size="0">建議尺寸:w280 x h230 / 72dpi</font></p>
