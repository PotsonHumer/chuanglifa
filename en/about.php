...
<?php
$id = $_GET["a_id"];
$query_fb = "SELECT * FROM bg_about WHERE id = '".$id."'";
$result_fb = mysqli_query($dbc,$query_fb)
	or die ('資料庫連結失敗');
$row_3 = mysqli_fetch_array($result_fb);
?>
<meta name property="og:title" content="<?php echo $row_3['web_title'] ?>"/> <!-- 分享的TITLE  -->
<meta name property="og:description" content="<?php echo $row_3['fb_ds'] ?>"/> <!-- 分享的內容描述 -->
<meta name property="og:url" content="http://www.chuanglifa.com/<?php echo $web_namee.'?'.$web_idd; ?>"/> <!-- 分享網頁的連結 -->
<meta property="og:image" content="<?php echo $row_3['fb_imge'] ?>"/> <!-- 圖片URL -->
<link href="css/style.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="css/default.css" type="text/css" />
<script type="text/javascript" src="js/jquery-1.8.1.min.js"></script>
<script type="text/javascript" src="js/jquery.nivo.slider.pack.js"></script>
<script type="text/javascript" src="js/chuanglifa_jQ.js"></script>
<title><?php echo $row_3['web_title'] ?></title>
</head>
<?php
$id = $_GET["a_id"];
...
$query_1 = "SELECT * FROM bg_about ORDER BY id ASC";
        ...
        <div id="main_2">
            <div class="left">
				...
				while($row_1 = mysqli_fetch_array($result)){
					?>
                    <div class="roject"><a href="about.php?a_id=<?php echo $row_1['id']?>"><?php echo $row_1['project']?></a></div>
                    <?
				}
				?>
                </div>
