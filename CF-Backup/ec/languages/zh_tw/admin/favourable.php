...
$_LANG['js_languages']['batch_drop_confirm'] = '確定刪除選取的優惠活動嗎？';
...
$_LANG['js_languages']['start_lt_end'] = '優惠開始時間不能晚於結束時間';

/* post */
$_LANG['pls_set_user_rank'] = '請設定享受優惠的會員等級';
$_LANG['pls_set_act_range'] = '請設定優惠範圍';
$_LANG['amount_error'] = '金額下限不能大於金額上限';
$_LANG['act_name_exists'] = '該優惠活動名稱已存在，請換一個';
