...
$_LANG['js_languages']['todolist_save'] = '儲存';
...
$_LANG['auto_redirection'] = '若您沒有選擇項目，系統將在 <span id="spanSeconds">3</span> 秒後自動跳到下方的第一個選項。';
$_LANG['password_rule'] = '密碼應只包含英文字符、數字.長度在6--16位之間';
$_LANG['username_rule'] = '會員名稱應為中文、英文字母、數字組合，3到15位';
...
$_LANG['charset']['en_us'] = '美式英語';
$_LANG['charset']['en_uk'] = '英式英文';

/* 新訂單通知 */
$_LANG['order_notify'] = '新訂單通知';
$_LANG['new_order_1'] = '您有 ';
$_LANG['new_order_2'] = ' 張新訂單以及 ';
$_LANG['new_order_3'] = ' 張新付款的訂單';
$_LANG['new_order_link'] = '按此檢視新訂單';
...
$_LANG['05_comment_manage']   = '會員評論';
$_LANG['06_goods_brand_list'] = '商品品牌';
$_LANG['07_brand_add']        = '新增品牌';
$_LANG['08_goods_type']       = '商品類型';
$_LANG['09_attribute_list']   = '商品規格';
$_LANG['10_attribute_add']    = '新增規格';
...
/* 促銷管理 */
$_LANG['02_snatch_list']    = '猜價競標';
$_LANG['snatch_add']        = '新增猜價競標';
...
$_LANG['14_package_list']   = '超值組合';
$_LANG['package_add']       = '新增商品組合';
...
$_LANG['06_undispose_booking'] = '預購登記';
...
$_LANG['10_user_account_manage'] = '管理儲值金';

/* 權限管理 */
$_LANG['admin_list'] = '管理者列表';
$_LANG['admin_add'] = '新增管理者';
$_LANG['admin_logs'] = '管理者記錄';
...
$_LANG['08_friendlink_list'] = '友情連結';
$_LANG['shipping_area_list'] = '配送區域';
$_LANG['sitemap']            = '網站地圖';
$_LANG['check_file_priv']    = '檔案權限檢測';
$_LANG['captcha_manage']     = '驗證碼管理';
$_LANG['fckfile_manage']     = '檔案上傳與管理';
$_LANG['ucenter_setup']      = 'UCenter設定';
$_LANG['file_check']         = '檔案檢查';
...
/* 積分兌換管理 */
$_LANG['15_exchange_goods']      = '紅利兌換商品';
$_LANG['15_exchange_goods_list'] = '積分商品列表';
$_LANG['exchange_goods_add']     = '新增商品';
...
/* 郵件發送錯誤資料 */
$_LANG['smtp_setting_error']   = '郵件伺服器設定資料不完整';
...
$_LANG['span_edit_help'] = '修改內容';
$_LANG['href_sort_help'] = '變更排序';
