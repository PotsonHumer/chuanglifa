...
$_LANG['notice_goods_name'] = '請先搜尋商品,將會產生商品選單...';
...
$_LANG['label_gift_integral'] = '贈送紅利積點數：';
...
$_LANG['notice_fail'] = '（取消訂單，保證金將退回會員儲值金帳戶，失敗原因可以寫到活動說明中）';
$_LANG['cancel_order_reason'] = '團購失敗';
$_LANG['js_languages']['succeed_confirm'] = '設定後將無法修改。確定設定此團購活動成功嗎？';
$_LANG['js_languages']['fail_confirm'] = '設定後將無法修改。確定設定此團購活動失敗嗎？';
$_LANG['button_mail'] = '發送郵件';
$_LANG['notice_mail'] = '（通知客戶付清餘款，以便出貨）';
$_LANG['mail_result'] = '該團購活動共有 %s 個有效訂單，成功發送 %s 封郵件。';
$_LANG['invalid_time'] = '您輸入一個無效的團購時間。';
...
$_LANG['js_languages']['error_gift_integral'] = '您輸入的贈送紅利積點數不是整數！';

/* 刪除團購活動 */
$_LANG['js_languages']['batch_drop_confirm'] = '確定刪除選擇的團購活動嗎？';
$_LANG['error_exist_order'] = '該團購活動已經有訂單，不能刪除！';
$_LANG['batch_drop_success'] = '成功刪除 %s 條團購活動記錄（已經有訂單的團購活動不能刪除）。';
