...
$_LANG['captcha_register'] = '新會員註冊';
$_LANG['captcha_login'] = '會員登入';
$_LANG['captcha_comment'] = '發表評論';
$_LANG['captcha_admin'] = '後台管理者登入';
$_LANG['captcha_login_fail'] = '登入失敗時顯示驗證碼';
$_LANG['login_fail_note'] = '選擇「是」將在會員登入失敗 3 次後才顯示驗證碼，選擇「否」將始終在登入時顯示驗證碼。注意: 只有在啟用會員登入驗證碼時本設定才有效';
...
$_LANG['js_languages']['proper_width'] = '圖片寬度要 40～145 之間!';
$_LANG['js_languages']['height_number'] = '圖片高度請輸入數字!';
$_LANG['js_languages']['proper_height'] = '圖片高度要在 15～50 之間!';
