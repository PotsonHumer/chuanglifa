...
$_LANG['move_up'] = '上移';
$_LANG['move_down'] = '下移';
$_LANG['continue_add'] = '繼續新增管理者';
$_LANG['back_list'] = '返回管理者列表';

$_LANG['admin_edit'] = '編輯管理者';
$_LANG['edit_pwd'] = '修改密碼';

$_LANG['back_admin_list'] = '返回管理者列表';

/* 提示資料 */
$_LANG['js_languages']['user_name_empty'] = '管理者會員名稱不能為空!';
...
$_LANG['edit_profile_succeed'] = '您已的修改個人帳號資料!';
$_LANG['edit_password_succeed'] = '您已的修改密碼，因此您必須重新登入!';
...
$_LANG['edit_navi'] = '設定個人導航';

/* 幫助資料 */
$_LANG['password_notic'] = '如果要修改密碼,請先填寫舊密碼,如留空,密碼保持不變';
$_LANG['email_notic'] = '輸入管理者的Email信箱,必須為Email格式';
...
$_LANG['click_for_another'] = '看不清？點圖更換驗證碼。';
