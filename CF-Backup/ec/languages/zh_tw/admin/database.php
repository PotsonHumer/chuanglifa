...
$_LANG['min_backup_note']    ='僅包括商品表，訂單表，會員表';
$_LANG['custom_backup']      ='自定備份';
$_LANG['custom_backup_note'] ='根據自行選擇備份資料表';

$_LANG['option']              = '其他選項';
$_LANG['ext_insert']          = '使用進階匯入(Extended Insert)方式';
...
$_LANG['restore_confirm']           = '還原資料庫會清除現有的所有內容，確定還原嗎？';
...
$_LANG['backup_notice'] = '如果您的瀏覽器沒有自動跳轉，請按這裡';
...
$_LANG['confirm_remove'] = '確定刪除選取的資料嗎？';
