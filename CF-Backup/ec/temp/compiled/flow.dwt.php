...
?>
          <tr>
            ...
            <td bgcolor="#ffffff" align="center" width="100"><a href="javascript:collect_to_flow(<?php echo $this->_var['goods']['goods_id']; ?>)" class="f6"><?php echo $this->_var['lang']['collect_to_flow']; ?></a></td>
          </tr>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </table>
      <?php endif; ?>
          ...
          <tr>
            ...
            <form action="flow.php?step=login" method="post" name="registerForm" id="registerForm" onsubmit="return checkSignupForm(this)">
               <table width="90%" border="0" cellpadding="8" cellspacing="1" bgcolor="#B0D8FF" class="table">
                  ...
                  <tr>
                    <td bgcolor="#ffffff"><div align="right"><strong><?php echo $this->_var['lang']['email_address']; ?></strong></div></td>
                  ...
                  <tr>
                    <td bgcolor="#ffffff"><div align="right"><strong><?php echo $this->_var['lang']['confirm_password']; ?></strong></div></td>
                  ...
                  <tr>
                    <td colspan="2" bgcolor="#ffffff" align="center">
                        <input type="submit" name="register" class="bnt_blue_1" value="<?php echo $this->_var['lang']['forthwith_register']; ?>" />
