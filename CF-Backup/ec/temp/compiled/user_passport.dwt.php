   ...
   <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()">
        <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
          ...
          <tr>
            ...
            <a href="user.php?act=get_password" class="f3"><?php echo $this->_var['lang']['get_password']; ?></a>
            </td>
          </tr>
   ...
   <div class="regtitle"></div>
    <form action="user.php" method="post" name="formUser" onsubmit="return register();">
      <table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3">
        <tr>
          <td width="11%" align="right"><?php echo $this->_var['lang']['label_username']; ?></td>
          <td width="89%">
        ...
        <tr>
          <td align="right"><?php echo $this->_var['lang']['other_msn']; ?></td>
          <td>
          <input name="other[msn]" type="text" size="25" class="inputBg" />
           </td>
        </tr>
        <tr>
          <td align="right"><?php echo $this->_var['lang']['other_qq']; ?></td>
          <td>
          <input name="other[qq]" type="text" size="25" class="inputBg"/>
           </td>
        </tr>
        <tr>
          <td align="right"><?php echo $this->_var['lang']['other_office_phone']; ?></td>
          <td>
          <input name="other[office_phone]" size="25" type="text" class="inputBg"/>
           </td>
        </tr>
        <tr>
          <td align="right"><?php echo $this->_var['lang']['other_home_phone']; ?></td>
          <td>
        ...
        <tr>
          <td align="right"><?php echo $this->_var['lang']['other_mobile_phone']; ?></td>
          <td>
