...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('data_count',  sprintf($xml, $_LANG['order_count_trend'], $data_count)); // 訂單數統計數據
    $smarty->assign('data_amount', sprintf($xml, $_LANG['order_amount_trend'], $data_amount));    // 銷售額統計數據
