...
$id = $_GET["a_id"];
$query_3 = "SELECT * FROM bg_business WHERE id = '".$id."'";
...
$query = "SELECT * FROM bg_business WHERE id = '".$id."'";
$result = mysqli_query($dbc,$query)
	or die ('資料庫連結失敗');
$row_2 = mysqli_fetch_array($result);

$query_1 = "SELECT * FROM bg_business";
        ...
        <div id="main_2">
            <div class="left">
				...
				while($row_1 = mysqli_fetch_array($result)){
					?>
                    <div class="roject"><a href="business.php?b_id=<?php echo $row_1['id']?>"><?php echo $row_1['project']?></a></div>
                    <?
				}
				?>
                </div>
