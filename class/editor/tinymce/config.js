// JavaScript Document
	...
	function tiny_load(ROOT_PATH,SELECT){
		...
		if(typeof(SELECT) == "undefined" || SELECT == ""){
			SELECT = "#elm1,#elm2,#elm3,#elm4,#elm5,#elm6,.mceEditor,.tiny";
		}
		...
		tinymce.init({
			...
			image_advtab: true,
			external_filemanager_path: ROOT_PATH +"class/editor/filemanager/",
			filemanager_title:"檔案管理" ,
			external_plugins: { "filemanager" : ROOT_PATH +"class/editor/filemanager/plugin.min.js"},
