...
<form action="bg_product_list_UPDATE.php?up_id=<?php echo $row_6['id']?>" method="post">
    ...
    <p>類別圖片:<input type="text" name="list_imge" value="<?php echo $row_6['list_imge']?>"><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a></p>
    <p>產品圖片-01:<input type="text" name="list_imge_1" value="<?php echo $row_6['list_imge_1']?>" ><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a></p>
    <p>產品圖片-02:<input type="text" name="list_imge_2" value="<?php echo $row_6['list_imge_2']?>"><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a></p>
    <p>產品圖片-03:<input type="text" name="list_imge_3" value="<?php echo $row_6['list_imge_3']?>"><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a></p>
    <p>產品圖片-04:<input type="text" name="list_imge_4" value="<?php echo $row_6['list_imge_4']?>"><a class="img_manage" href="#"><input type="button" value="▶ 點擊選擇圖片" /></a></p>
